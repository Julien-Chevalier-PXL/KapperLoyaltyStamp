  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <li class="nav-item">
        <a class="nav-link" href="#" title="Dashboard">
          <span class="fas fa-tachometer-alt"></span> Dashboard</a>
      </li>  
      <li class="nav-item">
        <a class="nav-link" href="/LoyaltyKapperNew/Kapper/QRGenerator.php" title="QR Generator">
          <span class="fas fa-qrcode"></span> Create stamp</a>
      </li>
    </ul>
    <ul class="navbar-nav ml-md-auto d-md-flex">
      <?php if (!isset($_SESSION["kapper_id"])) : ?>
      <li class="nav-item">
